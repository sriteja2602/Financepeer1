...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Complaint(s) not Process yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Complaint(s) Status in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Complaint(s) has been closed</p>
                      </div>
...
<?php }?>
      ...
      <h4>Hover over the icons to check your complaint status!</h4>
