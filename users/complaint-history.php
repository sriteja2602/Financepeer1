...
<html lang="en">
  <head>
    ...
    <title>GRS | Grievance History</title>
...
while($row=mysqli_fetch_array($query))
{
  ?>
                              <tr>
                                  <td allign="center"><?php echo htmlentities($row['complaintNumber']);?></td>
                                  <td allign="center"><?php echo htmlentities($row['regDate']);?></td>
                                 <td allign="center"><?php echo  htmlentities($row['lastUpdationDate']);

                                 ?></td>
                                  <td allign="center"><?php 
                                    $status=$row['status'];
